...
subjects = {'ASG1','ASG2','AY1','AY2','nl-0043_p1','nl-0045_p1','nl-0046_p1','PJK1','PJK2','VV1','VV2','WM'};

EEGpath = '~/Greta/2015_Ensembles_data/';
cd(EEGpath);
...
for s = 4:length(subjects)
    ...
    save(strcat(subjects{s},'_data4RSA.mat'), 'EEGdata', 'labelsByCond', 'labelsByExemp', 'EEGdata_downsampled')
end
